...
export default class KnowledgeSmallItem extends PureComponent{
  ...
  render(){
    ...
    return <div className="col-md-6">
      <div className="knowledge-smallitem p-2" style={{
            borderRadius: openInfo ? "8px 8px 0 0" : "8px",
            marginBottom: openInfo ? "140px" : ""}} key={key}>
        <CSSTransition
          in={openInfo}
          timeout={50}
          classNames="knowledge-smallitem-description">
          <div className="knowledge-smallitem-description">
            <p>{description}</p>
          </div>
        </CSSTransition>
        <div className="knowledge-smallitem-image">
          <img src={image ? image : '/svg/FIT_LOGO_NAVBAR.svg'} alt={title}/>
        </div>
        <div className="knowledge-smallitem-content">
