...
import {patchStaff, GetStaff} from '../../../redux/actions/staffActions'
...
export class EditStaff extends Component{
    ...
    componentDidMount(){
        ...
        document.title = "Редактировать сотрудника - Кафедра управления инновациями"
    }
    ...
    submitForm = e => {
        ...
        // При условии успеха + очистить форму
            ...
            <div className="container-md container-fluid">
                ...
                <form className="w-100 mt-3" onSubmit={this.submitForm}>
                    ...
                    <div className="w-100 mt-2 text-right">
                        ...
                        disabled={this.state.loading}>Обновить сотрудника</button>
                    </div>                 
                </form>
